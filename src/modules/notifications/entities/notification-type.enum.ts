...
export enum NotificationContentType {
  ...
  DOCUMENT_STATUS_UPDATED = 'DOCUMENT_STATUS_UPDATED', // Renamed from DOCUMENT_STATUS_CHANGED
  ...
  DOCUMENT_VERIFICATION_REQUESTED = 'DOCUMENT_VERIFICATION_REQUESTED', // Renamed from VERIFICATION_REQUESTED
  ...
  SYSTEM_UPGRADE_COMPLETED = 'SYSTEM_UPGRADE_COMPLETED',
  ...
  // Custom or Miscellaneous Notifications
  CUSTOM_NOTIFICATION = 'CUSTOM_NOTIFICATION', // Renamed from CUSTOM
}
